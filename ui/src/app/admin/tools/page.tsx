  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Maintenance operations for platform administrators.</p>
      </div>

      {/* Danger zone card */}
      <div className="border-2 border-red-200 dark:border-red-800 dark:border-red-900 rounded-xl overflow-hidden">
        <div className="bg-red-50 dark:bg-red-950 px-5 py-4 flex items-center gap-3 border-b border-red-200 dark:border-red-800 dark:border-red-900">
          <AlertTriangle className="w-5 h-5 text-red-600 dark:text-red-400 shrink-0" />
          <div>
            <p className="font-semibold text-red-900 dark:text-red-200">Danger Zone</p>
            <p className="text-xs text-red-700 dark:text-red-300 dark:text-red-400">These operations are irreversible.</p>
          </div>
        </div>
        ...
        <div className="bg-surface px-5 py-5 space-y-4">
          ...
          {/* Orthanc PACS note */}
          <div className="flex items-start gap-2 bg-amber-50 dark:bg-amber-950 border border-amber-200 dark:border-amber-800 dark:border-amber-900 rounded-lg px-3 py-2.5 text-xs text-amber-800 dark:text-amber-300">
          ...
          {result && (
            <div className="space-y-3">
              <div className="flex items-center gap-2 text-green-700 dark:text-green-300 dark:text-green-400">
