...
class MfaService:
    ...
    async def _consume_recovery_code(self, user_id: str, code: str) -> bool:
        ...
        stmt = (
            ...
            # MfaRecoveryCodeRecord.used_at is TIMESTAMP WITH TIME ZONE (project
            # convention, see domain.models.utcnow) — must stay tz-aware or asyncpg
            # rejects the write.
