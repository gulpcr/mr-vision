...
REGION: dict[str, Any] = {   'exam_phrase': 'a LOWER LIMB MRI',
    'region_words': 'the lower limb',
    'richread_image_phrase': 'axial multi-sequence MR panels spanning the lower limb',
    'targets': 'a soft-tissue or bone mass, a marrow signal abnormality (T1-dark / STIR-bright), a '
               'joint effusion, a muscle or tendon tear, a fluid collection or abscess, or a focal '
               'bone or soft-tissue lesion',
    'scan_normal_clause': 'NORMAL muscles, bones, tendons and joints are NOT findings. Do NOT flag '
                          'a level merely because limb structures are visible — that is normal '
                          'anatomy.',
    'scan_finding_examples': '"posterior-compartment soft-tissue mass", "femoral marrow lesion '
                             '(STIR-bright)", "joint effusion"',
    'organ_review': 'the bones and marrow signal, the joints and joint spaces, the muscles and '
                    'their compartments, the tendons and ligaments, the neurovascular bundles, and '
                    'the subcutaneous soft tissues',
    'relationship_examples': 'e.g. arising from or abutting a specific muscle compartment, '
                             'contacting the bone cortex or periosteum, displacing the '
                             'neurovascular bundle, crossing a fascial plane',
    'signal_patterns': 'In the limb: fluid, oedema and many tumours are bright on '
                       'T2/STIR/PD-fat-sat; fat is bright on T1 and suppressed on STIR; marrow '
                       'oedema is STIR-bright and T1-dark; a soft-tissue mass may enhance on T1+C.',
    'specificity_rules': 'SPECIFICITY (most studies are NORMAL): require corroboration before '
                         'calling a mass, tear or marrow lesion. A small joint effusion, mild '
                         'marrow signal, or minor degenerative change may be incidental. Normal '
                         'muscles, tendons and cortical bone are NOT findings.',
    'age_sensitive': False,
    'plane_word': 'axial'}
