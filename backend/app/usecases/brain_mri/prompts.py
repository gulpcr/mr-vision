...
REGION: dict[str, Any] = {   'exam_phrase': 'a BRAIN MRI',
    'region_words': 'the brain',
    'richread_image_phrase': 'axial multi-sequence MR panels spanning the brain',
    'targets': 'an intracranial mass or tumour, an acute infarct (DWI-bright / ADC-low), '
               'haemorrhage (SWI/GRE blooming), focal or confluent white-matter signal '
               'abnormality, mass effect or midline shift, hydrocephalus or ventricular '
               'enlargement, an extra-axial collection, or abnormal enhancement on T1+C',
    'scan_normal_clause': 'NORMAL grey and white matter, NORMAL ventricles and NORMAL CSF spaces '
                          'are NOT findings. Do NOT flag a level merely because brain, ventricles '
                          'or sulci are visible, or because CSF is bright on T2 — that is normal '
                          'anatomy, not pathology.',
    'scan_finding_examples': '"left MCA infarct (DWI-bright)", "right frontal enhancing mass with '
                             'oedema", "dilated lateral ventricles"',
    'organ_review': 'the cerebral hemispheres and grey/white matter, the ventricular system, the '
                    'basal ganglia and thalami, the corpus callosum and midline, the brainstem and '
                    'cerebellum, the extra-axial spaces, the sellar/pituitary region, the orbits, '
                    'and the visualized paranasal sinuses and mastoid air cells',
    'relationship_examples': 'e.g. exerting mass effect on the adjacent ventricle, effacing the '
                             'sulci, crossing or sparing the midline, abutting the falx or '
                             'tentorium, involving grey vs white matter',
    'signal_patterns': 'In the brain: normal CSF is bright on T2 and dark (suppressed) on FLAIR; '
                       'white matter is slightly darker than grey matter on T2/FLAIR. An ACUTE '
                       'INFARCT is bright on DWI with low ADC (restricted diffusion) and can be '
                       'subtle elsewhere; vasogenic oedema and gliosis are bright on T2/FLAIR; '
                       'haemorrhage / microbleeds BLOOM (dark) on SWI/GRE; an enhancing mass '
                       'brightens on T1+C. Do NOT mistake normal bright CSF on T2 for a lesion.',
    'specificity_rules': 'SPECIFICITY & CHARACTERIZATION (most brain MRIs are NORMAL). Apply these '
                         'GENERAL principles to EVERY possible finding — do not anchor on any one '
                         'diagnosis: (1) CORROBORATE before asserting — call something abnormal '
                         'only when it is supported across the sequences that would confirm it, '
                         'and characterize it by its signal on each; a signal on a single sequence '
                         'with no correlate is usually artefact, shine-through, or normal '
                         'variation (for example, true diffusion restriction needs DWI-high AND '
                         'ADC-LOW not DWI alone; enhancement needs a post-contrast T1 brighter '
                         'than the non-contrast T1). (2) NEVER DISMISS a genuine, corroborated '
                         "abnormality as 'normal' or 'age-related' — but equally do not "
                         'manufacture pathology; concluding the study is normal is correct when it '
                         'is. (3) USE PATIENT AGE and any history to weight the significance AND '
                         'the differential of ANY finding — a pattern that is expected/benign at '
                         'one age can be abnormal at another (for example, a few tiny scattered '
                         'T2/FLAIR white-matter foci in an OLDER adult are usually nonspecific '
                         'chronic microvascular change, whereas bilateral-symmetric/confluent, '
                         'cerebellar/brainstem/deep-grey, or ANY white-matter signal in a patient '
                         'under ~50 is abnormal — small-vessel disease is rare under 50 — and '
                         'warrants a differential + follow-up). Do not explain a finding away as '
                         "age-related when the patient's age makes that implausible. Normal CSF, "
                         'symmetric normal structures and flow voids are NOT findings.',
    'age_sensitive': True,
    'plane_word': 'axial'}
