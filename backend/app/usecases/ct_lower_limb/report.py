"""Two-pass MedGemma orchestration for ct_lower_limb.
...
from app.usecases.ct_lower_limb import prompts
...
async def rich_read(
    *,
    ...
    logger.info("ct_lower_limb_rich_read", images=len(images), has_report=bool(parsed))
    return parsed
