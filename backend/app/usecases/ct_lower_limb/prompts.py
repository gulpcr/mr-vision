...
REGION: dict[str, Any] = {
    'exam_phrase': 'a LOWER LIMB CT',
    'region_words': 'the lower limb',
    'richread_image_phrase': 'axial bone- and soft-tissue-windowed images spanning the lower limb',
    'targets': 'a fracture or dislocation, a soft-tissue mass, a collection or abscess, a joint effusion, a bony lesion, osteomyelitis or cortical destruction, or a foreign body',
    'window_hints': {
        'bone': 'cortex and medulla - fractures, lesions, cortical destruction',
        'soft-tissue': 'muscles, masses, collections, joint effusions, vessels',
    },
    'scan_normal_clause': 'NORMAL bones, muscle compartments and vessels are NOT findings. Do NOT flag a slice merely because bone, muscle or vessels are visible on it - that is normal anatomy, not pathology.',
    'scan_finding_examples': '"comminuted tibial shaft fracture", "intramuscular collection", "aggressive lytic femoral lesion"',
    'report_multiwindow_detail': 'bone: cortex/medulla/fractures/lesions; soft-tissue: muscles/masses/collections/joint effusions',
    'organ_review': 'the visualized bones (cortex and medulla - fractures, lesions), the adjacent joints (effusion, alignment), the muscle compartments, the subcutaneous soft tissues, and the visualized vessels',
    'relationship_examples': 'e.g. extending into the adjacent joint, breaching the cortex, displacing or involving a muscle compartment, abutting the neurovascular bundle',
}
