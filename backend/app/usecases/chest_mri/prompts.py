...
REGION: dict[str, Any] = {   'exam_phrase': 'a CHEST MRI',
    'region_words': 'the chest',
    'richread_image_phrase': 'axial multi-sequence MR panels spanning the chest',
    'targets': 'a pulmonary or mediastinal mass, mediastinal or hilar lymphadenopathy, a pleural '
               'or pericardial effusion, a cardiac or great-vessel abnormality, a chest-wall '
               'lesion, or focal abnormal signal',
    'scan_normal_clause': 'NORMAL lungs, normal-calibre vessels and the normal heart are NOT '
                          'findings. Do NOT flag a level merely because lung, vessels, heart or '
                          'mediastinum are visible — that is normal anatomy.',
    'scan_finding_examples': '"right lower lobe mass", "left pleural effusion", "mediastinal '
                             'lymphadenopathy"',
    'organ_review': 'the lungs, the pleura (effusion, thickening), the mediastinum and hila (lymph '
                    'nodes, masses), the heart and pericardium, the great vessels (aorta, '
                    'pulmonary arteries), and the visualized chest wall and thoracic skeleton',
    'relationship_examples': 'e.g. abutting the pleura or chest wall, contacting the mediastinum, '
                             'encasing or displacing a vessel, associated with adjacent '
                             'atelectasis or effusion',
    'signal_patterns': 'In the chest: fluid, oedema and many masses are bright on T2; a mass may '
                       'enhance on T1+C; vessels show dark flow voids; aerated lung is signal-poor '
                       'on all sequences.',
    'specificity_rules': 'SPECIFICITY (most studies are NORMAL): require corroboration before '
                         'calling a mass, node or effusion. Normal vessels (flow voids), the '
                         'normal heart and signal-poor aerated lung are NOT findings; do not '
                         'over-call normal mediastinal or hilar structures.',
    'age_sensitive': False,
    'plane_word': 'axial'}
