...
REGION: dict[str, Any] = {
    'exam_phrase': 'a FACE (MAXILLOFACIAL) CT',
    'region_words': 'the facial skeleton',
    'richread_image_phrase': 'axial bone- and soft-tissue-windowed images spanning the facial skeleton',
    'targets': 'a facial fracture (orbital wall/floor, nasal, zygomaticomaxillary complex, maxillary / Le Fort, or mandibular), paranasal sinus disease (mucosal thickening, opacification, an air-fluid level or a polyp), an orbital abnormality, a soft-tissue mass or collection, a bony lesion or cortical destruction, or a foreign body',
    'window_hints': {
        'bone': 'facial bones, orbital and sinus walls - fractures and bony lesions',
        'soft-tissue': 'orbits, sinus contents, soft-tissue masses and collections',
    },
    'scan_normal_clause': 'NORMAL facial bones, clear aerated sinuses, symmetric orbits and normal soft tissues are NOT findings. Do NOT flag a slice merely because bones, sinuses, orbits or soft tissues are visible on it - that is normal anatomy, not pathology.',
    'scan_finding_examples': '"left orbital floor blowout fracture", "maxillary sinus air-fluid level", "zygomaticomaxillary complex fracture"',
    'report_multiwindow_detail': 'bone: facial bones/orbital and sinus walls/fractures; soft-tissue: orbits/sinus contents/soft-tissue masses',
    'organ_review': 'the facial bones (orbital walls, zygoma, maxilla, nasal bones, mandible), the paranasal sinuses (maxillary, ethmoid, frontal, sphenoid - aeration, mucosal thickening, air-fluid levels), the orbits and globes, the nasal cavity and septum, the temporomandibular joints, and the visualized soft tissues',
    'relationship_examples': 'e.g. involving the orbital floor, extending into the maxillary sinus, disrupting the zygomaticomaxillary buttress, herniating orbital contents',
}
