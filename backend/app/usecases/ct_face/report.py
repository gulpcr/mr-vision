"""Two-pass MedGemma orchestration for ct_face.
...
from app.usecases.ct_face import prompts
...
async def rich_read(
    *,
    ...
    logger.info("ct_face_rich_read", images=len(images), has_report=bool(parsed))
    return parsed
