...
REGION: dict[str, Any] = {   'exam_phrase': 'an ABDOMEN/PELVIS MRI',
    'region_words': 'the abdomen and pelvis',
    'richread_image_phrase': 'axial multi-sequence MR panels spanning the abdomen and pelvis',
    'targets': 'a mass/lesion, organ enlargement, hydronephrosis, a biliary or renal calculus or '
               'obstruction, bowel wall thickening, lymphadenopathy, free fluid, an aortic '
               'aneurysm, or a focal parenchymal signal abnormality (e.g. DWI-restricting or '
               'enhancing lesion)',
    'scan_normal_clause': 'NORMAL organs, NORMAL bowel and NORMAL vessels are NOT findings, and a '
                          'simple bright-T2 cyst may be incidental. Do NOT flag a level merely '
                          'because organs / bowel / vessels are visible — that is normal anatomy.',
    'scan_finding_examples': '"hepatic lesion (T2-bright, DWI-restricting)", "right adnexal mass", '
                             '"left hydronephrosis"',
    'organ_review': 'the liver, gallbladder and biliary tree, spleen, pancreas, adrenals, kidneys, '
                    'bowel, mesentery/peritoneum (free fluid), abdominal aorta and vessels, lymph '
                    'nodes, the pelvic organs, and the visualized bones',
    'relationship_examples': 'e.g. abutting the adjacent bowel or bladder, in contact with the '
                             'liver capsule, displacing a vessel, fat planes preserved or '
                             'indistinct',
    'signal_patterns': 'In the abdomen: simple fluid, cysts and bile are very bright on T2; solid '
                       'lesions are intermediate on T2, often RESTRICT on DWI (DWI-bright / '
                       'ADC-low) and ENHANCE on T1+C; fat loses signal on opposed-phase or '
                       'fat-saturated T1.',
    'specificity_rules': 'SPECIFICITY (most studies are NORMAL): a simple, uniformly bright-T2 '
                         'lesion with NO DWI restriction (bright DWI + low ADC) and no T1+C '
                         'enhancement is a benign cyst — do NOT call it a mass. Require DWI/ADC or '
                         'enhancement corroboration before calling a solid lesion. Normal organs, '
                         'bowel and vessels are NOT findings.',
    'age_sensitive': False,
    'plane_word': 'axial'}
