...
REGION: dict[str, Any] = {
    'exam_phrase': 'a LUMBAR SPINE CT',
    'region_words': 'the lumbar spine',
    'richread_image_phrase': 'axial bone- and soft-tissue-windowed images spanning the lumbar spine',
    'targets': 'a fracture or vertebral collapse, spondylolisthesis or malalignment, a disc herniation or bulge, central canal or neural-foraminal stenosis, degenerative change (osteophytes, facet arthropathy, disc-space narrowing), a lytic or blastic bony lesion, or a paraspinal soft-tissue abnormality',
    'window_hints': {
        'bone': 'vertebrae, fractures, degenerative change, lytic/blastic lesions',
        'soft-tissue': 'discs, thecal sac and canal, paraspinal soft tissues',
    },
    'scan_normal_clause': 'NORMAL vertebral alignment, normal discs and normal paraspinal soft tissues are NOT findings, and mild age-expected degenerative change alone need not be flagged. Do NOT flag a slice merely because vertebrae, discs or the canal are visible on it - that is normal anatomy.',
    'scan_finding_examples': '"L1 compression fracture", "L4-L5 disc herniation with canal stenosis", "lytic lesion in the L3 vertebral body"',
    'report_multiwindow_detail': 'bone: vertebrae/fractures/degenerative change/lesions; soft-tissue: discs/thecal sac/paraspinal tissues',
    'organ_review': 'the vertebral bodies and posterior elements (alignment, height, lesions), the intervertebral discs, the central spinal canal and thecal sac, the neural foramina, the facet joints and pars interarticularis, and the paraspinal soft tissues',
    'relationship_examples': 'e.g. narrowing the central canal, encroaching on a neural foramen, indenting the thecal sac, retropulsed into the canal',
}
