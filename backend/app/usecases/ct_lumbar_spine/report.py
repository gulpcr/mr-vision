"""Two-pass MedGemma orchestration for ct_lumbar_spine.
...
from app.usecases.ct_lumbar_spine import prompts
...
async def rich_read(
    *,
    ...
    logger.info("ct_lumbar_spine_rich_read", images=len(images), has_report=bool(parsed))
    return parsed
...
async def scan_and_report(
    *,
    ...
    logger.info(
        "ct_lumbar_spine_report_complete",
