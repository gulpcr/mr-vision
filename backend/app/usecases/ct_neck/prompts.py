...
REGION: dict[str, Any] = {
    'exam_phrase': 'a NECK CT',
    'region_words': 'the neck',
    'richread_image_phrase': 'axial soft-tissue- and bone-windowed images spanning the neck',
    'targets': 'a mass or soft-tissue lesion of the oral cavity, tongue, base of tongue, floor of mouth, tonsils, oropharynx, nasopharynx or hypopharynx, focal or asymmetric thickening or abnormal enhancement of the tongue or a pharyngeal wall, cervical lymphadenopathy, an abscess or fluid collection, a thyroid or salivary-gland abnormality, airway narrowing or compromise, a vascular abnormality, or bone erosion or a bony lesion',
    'window_hints': {
        'soft-tissue': 'the tongue, oral cavity, oropharynx, masses, nodes, thyroid, salivary glands, airway, vessels',
        'bone': 'the cervical spine and laryngeal cartilages - erosion, lesions, fractures',
    },
    'scan_normal_clause': 'A NORMAL symmetric tongue and floor of mouth, NORMAL thyroid, salivary glands, small reactive-sized nodes and normal vessels are NOT findings. Do NOT flag a slice merely because the tongue, glands, nodes, airway or vessels are visible on it - that is normal anatomy, not pathology. But ASYMMETRY, focal thickening, a mass or abnormal enhancement of the tongue, base of tongue, floor of mouth or a pharyngeal wall IS a finding worth flagging.',
    'scan_finding_examples': '"ill-defined thickening of the left base of tongue", "enlarged left level II lymph node", "right parotid mass"',
    'report_multiwindow_detail': 'soft-tissue: tongue/oral cavity/oropharynx/masses/nodes/glands/airway/vessels; bone: cervical spine and cartilage erosion/lesions',
    'organ_review': 'the oral cavity and tongue (including the base of tongue and floor of mouth - symmetry, focal thickening, mass or abnormal enhancement), the tonsils and oropharynx, the nasopharynx and hypopharynx, the thyroid gland, the parotid and submandibular salivary glands, the cervical lymph node levels, the larynx and airway, the carotid and jugular vessels, the visualized cervical spine, and the surrounding soft tissues',
    'relationship_examples': 'e.g. crossing the tongue midline, involving the floor of mouth, displacing the airway, abutting the carotid sheath, in contact with the thyroid or a salivary gland, effacing adjacent fat planes',
}
