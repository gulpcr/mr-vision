"""Two-pass MedGemma orchestration for ct_neck.
...
from app.usecases.ct_neck import prompts
...
async def rich_read(
    *,
    ...
    logger.info("ct_neck_rich_read", images=len(images), has_report=bool(parsed))
    return parsed
