...
REGION: dict[str, Any] = {
    'exam_phrase': 'a CHEST CT',
    'region_words': 'the chest',
    'richread_image_phrase': 'axial lung- and mediastinal-windowed images spanning the chest',
    'targets': 'a pulmonary nodule or mass, consolidation, ground-glass opacity, a pleural effusion, pneumothorax, emphysema or fibrosis, mediastinal or hilar lymphadenopathy, a mediastinal mass, cardiomegaly or pericardial effusion, an aortic abnormality, or a bony lesion',
    'window_hints': {
        'lung': 'pulmonary nodules, consolidation, ground-glass, emphysema, fibrosis, pneumothorax',
        'mediastinal': 'mediastinal/hilar nodes and masses, pleura, heart, great vessels',
        'bone': 'ribs and thoracic spine - lesions and fractures',
    },
    'scan_normal_clause': 'NORMAL aerated lung, normal-calibre vessels and the normal heart are NOT findings. Do NOT flag a slice merely because lung, vessels, heart or mediastinum are visible on it - that is normal anatomy, not pathology.',
    'scan_finding_examples': '"right upper lobe spiculated nodule", "left pleural effusion", "mediastinal lymphadenopathy"',
    'report_multiwindow_detail': 'lung: nodules/consolidation/ground-glass/emphysema; mediastinal: nodes/masses/pleura/heart/vessels; bone: rib and spine lesions/fractures',
    'organ_review': 'the lungs (each lobe - nodules, consolidation, ground-glass, emphysema, fibrosis), the pleura (effusion, pneumothorax, thickening), the mediastinum and hila (lymph nodes, masses), the heart and pericardium, the great vessels (aorta, pulmonary arteries), the airways, and the visualized chest wall and bones (ribs, thoracic spine)',
    'relationship_examples': 'e.g. abutting the pleura or chest wall, contacting the mediastinum, encasing or displacing a vessel or bronchus, associated with adjacent atelectasis',
}
