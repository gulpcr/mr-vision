"""Two-pass MedGemma orchestration for ct_chest.
...
from app.usecases.ct_chest import prompts
...
async def rich_read(
    *,
    ...
    logger.info("ct_chest_rich_read", images=len(images), has_report=bool(parsed))
    return parsed
