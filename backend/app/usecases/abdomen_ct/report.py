"""Two-pass MedGemma orchestration for abdomen_ct.
...
from app.usecases.abdomen_ct import prompts
...
async def rich_read(
    *,
    ...
    logger.info("abdomen_ct_rich_read", images=len(images), has_report=bool(parsed))
    return parsed
